...
import com.itzhai.rpc.nettyrpc.model.MessageKeyVal;
...
public class MessageRecvExecutor implements ApplicationContextAware, InitializingBean {
    ...
    public void setApplicationContext(ApplicationContext ctx) throws BeansException {
        try {
            MessageKeyVal keyVal = (MessageKeyVal) ctx.getBean(Class.forName("com.itzhai.rpc.nettyrpc.model.MessageKeyVal"));
